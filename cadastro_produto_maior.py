...
=======
from Tkinter import *
from cadastro_produto_menor import *
# funcao para teste
>>>>>>> origin/Marinho
def Teste():
    print("Testado")
...
root.mainloop()
=======
def theBigProdMenu(): #Criei essa funcao para que a janela so excute nesta chamada, sem ela sempre e aberta a janela
                        #independente do que seja invocado por funcao.
    root=Tk()
    ...
    # espaco com "inserir", "editar", "excluir" e "pesquisar"
            ...
            self.espaco1 = Label(self.container2, text="             ")
            self.espaco1.pack(side=LEFT)
            self.inserir = Button(self.container2, text="Inserir", command=Teste_menor)
            self.inserir["font"] = ("Arial", "10")
            self.inserir['padx'] = 10
            self.inserir.pack(side=LEFT)
            self.espaco2 = Label(self.container2, text="             ")
